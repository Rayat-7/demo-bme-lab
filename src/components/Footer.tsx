          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-6 mb-8">
                <img src="/images/transparent original logo.png" alt="BRL Logo" className="h-20 w-auto" />
                <div className="h-12 w-[1px] bg-white/20" />
                <img src="/images/uiu-logo.png" alt="UIU Logo" className="h-16 w-auto" />
              </div>
            ...
            <div className="flex flex-col gap-6">
              <h3 className="text-xs font-bold uppercase tracking-widest text-white/30">Connect</h3>
              <ul className="flex flex-col gap-4 font-medium">
                <li><Link to="/" className="hover:text-white/50 transition-colors">Research</Link></li>
                <li><Link to="/about" className="hover:text-white/50 transition-colors">About</Link></li>
                <li><a href="#" className="hover:text-white/50 transition-colors">Facilities</a></li>
                <li><a href="#" className="hover:text-white/50 transition-colors">LinkedIn</a></li>
              </ul>
            </div>
            
            <div className="flex flex-col gap-6">
              <h3 className="text-xs font-bold uppercase tracking-widest text-white/30">Contact</h3>
              <div className="flex flex-col gap-4 font-medium text-white/70">
                <p>United City, Madani Ave,<br />Dhaka 1212, Bangladesh</p>
                <a href="mailto:tahmina@pharmacy.uiu.ac.bd" className="text-white hover:underline underline-offset-4">
