      ...
      <div className="max-w-[1400px] mx-auto px-6 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {equipmentData.map((item) => (
            <div key={item.id} className="group bg-brand-bg rounded-[32px] p-8 border border-brand-border hover:border-brand-text/20 transition-all duration-500 flex flex-col items-start hover:shadow-2xl hover:-translate-y-2">
              <div className="mb-8 w-full aspect-[4/3] rounded-2xl overflow-hidden bg-brand-border shadow-sm group-hover:shadow-xl transition-shadow duration-500">
